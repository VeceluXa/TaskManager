...
public class TaskDatabaseHelper {
    ...
    /*public void insertTask(String tasknName, String[] subtasks){
        SQLiteDatabase db = taskDbAdapter.getWritableDatabase();
        taskValues = new ContentValues();
        taskValues.put(taskNameClmn, tasknName);
    ...
    public void insertTask(String tasknName, ArrayList<String> subtasks){
        SQLiteDatabase db = taskDbAdapter.getWritableDatabase();
        taskValues = new ContentValues();
        taskValues.put(taskNameClmn, tasknName);
        taskValues.put(subtasksNameClmn, convertArrToStr(subtasks));
    ...
    public void updateTaskByName(String tasknName, ArrayList<String> subtasks){
        SQLiteDatabase db = taskDbAdapter.getWritableDatabase();
        taskValues = new ContentValues();
        taskValues.put(taskNameClmn, tasknName);
        taskValues.put(subtasksNameClmn, convertArrToStr(subtasks));
        db.update(tableName, taskValues, taskNameClmn + " = ?", new String[] {tasknName});
        //db.execSQL("DROP TABLE " + tableName);
        System.out.println("WELL DONE");
        db.close();
    }

    public void updateTaskByIndex(int index, String tasknName, ArrayList<String> subtasks){
        SQLiteDatabase db = taskDbAdapter.getWritableDatabase();
        taskValues = new ContentValues();
        taskValues.put(taskNameClmn, tasknName);
        taskValues.put(subtasksNameClmn, convertArrToStr(subtasks));
